...
ols = function(formula, data, intercept = TRUE, var_method = "Standard") {
  ...
  out$f.stat = c(test.stat = ftest.stat, num.par = out$rank - as.numeric(intercept), df.residual = out$df.residual,
