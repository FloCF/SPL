...
testing_heterosced_ols = function(lmobject) {
  ...
  # Extract R squared and multiply by number of observation for BP test statistic
  ...
  # Conduct White test
  ## White test is basically the same as the Breusch-Pagan, with additionaly including cross-terms and sqaured
  ## of the explanetory variables.
